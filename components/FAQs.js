      ...
      <div className="container">
        <ul className={styles.faq}>
          ...
          <li className={`${styles.faq_item} ${ativo === 'item2' ? activeClass : ''}`} onClick={() => toggleClass('item2')}>
            ...
            <div className={styles.faq_item__texto}>
              <p>Todos os imunizantes ofertados à população são testados e aprovados pela Agência Nacional de Vigilância Sanitária (Anvisa) antes de serem disponibilizados. Na fabricação, depois de feitos todos os testes, a empresa precisa apresentar a documentação referente aos resultados das pesquisas. Assim, técnicos da Anvisa verificam os dados de segurança, eficácia e qualidade do imunizante para, então, liberar a comercialização. Os imunizantes disponíveis nos postos de saúde passaram por todo esse processo e tem segurança garantida.</p>
            </div>
          </li>
          ...
          <li className={`${styles.faq_item} ${ativo === 'item5' ? activeClass : ''}`} onClick={() => toggleClass('item5')}>
            ...
            <div className={styles.faq_item__texto}>
              <p>As vacinas aprovadas pela Anvisa para uso em crianças passaram por vários testes internacionais antes de serem liberadas no Brasil. Essas vacinas são consideradas seguras e fornecem boa proteção contra a Covid-19 para o público infantil.</p>

              <p>A vacinação infantil contra a covid-19 é dividida por faixa etária. </p>

              <p>Crianças de 6 meses a 4 anos e 11 meses recebem a Pfizer Baby. Neste caso, são três doses, com intervalo de 4 semanas entre as 2 primeiras e de oito semanas entre a segunda e a terceira. As crianças de 3 e 4 anos que tomaram duas doses de CoronaVac devem receber uma dose de reforço, com o imunizante Pfizer Baby, quatro meses após a segunda dose.</p>

              <p>Crianças de 5 anos a 11 anos recebem a vacina Pfizer Pediátrica. O esquema básico é de duas doses, com intervalo de 21 dias. Já o reforço (terceira dose) deve ser aplicado quatro meses após a segunda dose.</p>

              <p>A vacina CoronaVac está disponível para segunda dose de crianças que tomaram a primeira dose desse imunizante. São duas doses, com intervalo de 28 dias. Todas as crianças devem estar acompanhadas dos pais ou responsáveis, cartão de vacina e documento de identificação.</p>
          ...
          <li className={`${styles.faq_item} ${ativo === 'item6' ? activeClass : ''}`} onClick={() => toggleClass('item6')}>
            ...
            <div className={styles.faq_item__texto}>
              <p>Não é verdade que as crianças não desenvolvem casos graves da Covid-19. Apesar de, em geral, ficarem menos doentes em comparação aos adultos, é muito importante que as crianças se vacinem. As vacinas podem não impedir que a criança contraia o vírus que causa a Covid-19, mas ela protege contra quadros graves da doença.</p>
            </div>
          </li>
          ...
          <li className={`${styles.faq_item} ${ativo === 'item7' ? activeClass : ''}`} onClick={() => toggleClass('item7')}>
            ...
            <div className={styles.faq_item__texto}>
              ...
              <p>Os casos leves, como vermelhidão, dor no local da aplicação e febre podem ser cuidados e orientados nos postos de saúde . Já os casos mais complicados, que incluem alergia grave aos componentes da vacina devem ser levados para a unidade de saúde mais próxima. As bases do Samu estão preparadas para oferecer apoio a todos os pontos de vacinação.</p>
            </div>
          </li>
        </ul>
      </div>
